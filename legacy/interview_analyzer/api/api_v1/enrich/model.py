...
class LabelledUtterance(BaseModel):
    ...
    speaker: str = fd(description="The name of the speaker as given")
    speaker_type: Literal["Interviewer", "Interviewee"] = fd(
    ...
    text: str = fd(description="The text of the utterance.")
    speech_type: Literal["Question", "Answer", "Continuation", "Irrelevant"] = fd(
    ...
    question_type: Literal["Behavioral", "Technical", "None"] = fd(
        description="""When a new question is identified, determine if it is a \"Behavioral\" question or
                    ...
                    \"General\" questions should be labelled as \"Behavioral\". "
