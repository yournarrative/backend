...
from interview_analyzer.core.open_ai.assistants.assistant_instructions import star_method_instructions
from interview_analyzer.core.open_ai.assistants.assistant_manager import AssistantManager
