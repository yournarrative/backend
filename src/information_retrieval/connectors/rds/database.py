...
from information_retrieval.connectors.rds.model import create_extensions, Base, create_update_triggers, \
...
class DatabaseAccessLayer:
    ...
    async def _init_db(self):
        ...
        sql_files = (
            ...
            "02-documents-table-data-init",
        )

        for file in sql_files:
            with open(f"resources/sql/information_retrieval/{file}.sql") as f:
                sql_code = f.read()
